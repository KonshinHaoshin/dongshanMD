...
const dict: I18nDict = {
  ...
  'settings.imagePaste.absolute': { 'zh-CN': '绝对路径（保存文件）', 'en-US': 'Absolute path (Save)' },
  ...
  'format.toc': { 'zh-CN': '目录', 'en-US': 'TOC' },
  'typing.stats': { 'zh-CN': '{done}/{total} tasks', 'en-US': '{done}/{total} tasks' },
  'typing.noTasks': { 'zh-CN': '0 tasks', 'en-US': '0 tasks' },
  'print.command': { 'zh-CN': '打印 (Ctrl+P)', 'en-US': 'Print (Ctrl+P)' },
  'settings.customCss': { 'zh-CN': '自定义 CSS', 'en-US': 'Custom CSS' },
  'settings.customCssPlaceholder': { 'zh-CN': '输入自定义 CSS...', 'en-US': 'Enter custom CSS...' },
  'template.title': { 'zh-CN': '从模板新建', 'en-US': 'New from Template' },
  'template.blank': { 'zh-CN': '空白文档', 'en-US': 'Blank' },
  'template.saveAs': { 'zh-CN': '保存为模板', 'en-US': 'Save as Template' },
  'template.savePrompt': { 'zh-CN': '模板名称', 'en-US': 'Template name' },
  'template.loadFailed': { 'zh-CN': '加载模板失败', 'en-US': 'Failed to load template' },
  'history.title': { 'zh-CN': '历史版本', 'en-US': 'File History' },
  'history.noVersions': { 'zh-CN': '无历史版本', 'en-US': 'No history' },
  'history.restore': { 'zh-CN': '恢复', 'en-US': 'Restore' },
  'history.restoreConfirm': { 'zh-CN': '恢复到此版本？当前内容将被覆盖。', 'en-US': 'Restore to this version? Current content will be overwritten.' },
  'globalSearch.title': { 'zh-CN': '全局搜索', 'en-US': 'Global Search' },
  'globalSearch.placeholder': { 'zh-CN': '搜索所有打开的标签...', 'en-US': 'Search all open tabs...' },
  'globalSearch.noResults': { 'zh-CN': '没有搜索结果', 'en-US': 'No results' },
  'outline.dragHint': { 'zh-CN': '拖拽重新排序', 'en-US': 'Drag to reorder' },
};
